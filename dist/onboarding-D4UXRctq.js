import { Ct as probeGatewayReachable, Dt as summarizeExistingConfig, G as readRestartSentinel, K as summarizeRestartSentinel, Nt as getRemoteSkillEligibility, Ot as waitForGatewayReachable, St as printWizardHeader, Tt as resolveControlUiLinks, at as formatUsageReportLines, bt as normalizeGatewayTokenInput, dt as DEFAULT_WORKSPACE, fr as lookupContextTokens, ft as applyWizardMetadata, gt as formatControlUiSshHint, ht as ensureWorkspaceAndSessions, it as loadProviderUsageSummary, jt as normalizeControlUiBasePath, mt as detectBrowserOpenSupport, p as listAgentsForGateway, vt as handleReset, wt as randomToken, xt as openUrl, yr as peekSystemEvents } from "./reply-dpzhSRJz.js";
...
import { A as VERSION, c as writeConfigFile, i as loadConfig, o as readConfigFileSnapshot } from "./config-BgesjbOU.js";
import { n as listChannelPlugins } from "./plugins-BUOltOVc.js";
import { L as resolveMainSessionKey, d as loadSessionStore } from "./sandbox-DRFM-VuR.js";
import { d as inspectPortUsage, f as resolveLsofCommandSync, p as formatPortDiagnostics } from "./chrome-DXeEqzlO.js";
import { o as resolveStorePath } from "./paths-dxnbLZuf.js";
import { n as getMemorySearchManager } from "./memory-CZ3Y3KK-.js";
import { t as buildChannelSummary } from "./channel-summary-YVQVIBBH.js";
...
import { a as findTailscaleBinary, o as getTailnetHostname, s as readTailscaleStatusJson } from "./tailscale-DL3r7EER.js";
import { a as gatewayInstallErrorHint, i as buildGatewayInstallPlan, n as GATEWAY_DAEMON_RUNTIME_OPTIONS, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-igZ4hBae.js";
...
import { c as promptDefaultModel, d as warnIfModelConfigLooksOff, f as applyAuthChoice, g as promptAuthChoiceGrouped, r as promptRemoteGatewayConfig, s as applyPrimaryModel, t as setupSkills, u as resolvePreferredProviderForAuthChoice } from "./onboard-skills-DvHiIIG6.js";
import { n as setupChannels } from "./onboard-channels-CwxFU1dC.js";
import { l as healthCommand, n as ensureControlUiAssetsBuilt, s as formatHealthChannelLines, t as formatHealthCheckFailure, u as resolveHeartbeatSummaryForAgent } from "./health-format-CGAqId7r.js";
import { C as resolveEffectiveUpdateChannel, S as normalizeUpdateChannel, d as formatUpdateOneLiner, f as getUpdateCheckResult, h as compareSemverStrings, l as ensureCompletionCacheExists, m as checkUpdateStatus, p as resolveUpdateAvailability, s as checkShellCompletionStatus, u as formatUpdateAvailableHint, x as formatUpdateChannelLabel } from "./update-runner-B5vMZaNe.js";
import { i as probeGateway, t as runSecurityAudit } from "./audit-BYMr_PRw.js";
import { t as renderTable } from "./table-BGckvCec.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-BU_CzdFV.js";
import { o as resolveGatewayLogPaths, t as resolveGatewayService } from "./service-uHr-jUwR.js";
import { r as isSystemdUserServiceAvailable } from "./systemd-CygI0Jrf.js";
import { o as readLastGatewayErrorLine } from "./service-audit-CrZjNGvk.js";
import { t as resolveNodeService } from "./node-service-DM1af1kY.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-BdrlvuAq.js";
import { i as redactSecrets, n as formatDuration$1, r as formatGatewayAuthUsed, t as formatAge$1 } from "./format-DtYcaIY0.js";
import { r as installCompletion } from "./completion-cli-4EM3qNKp.js";
import { t as buildWorkspaceHookStatus } from "./hooks-status-CLfJAHQD.js";
...
async function finalizeOnboardingWizard(options) {
	...
	if (process.platform === "linux" && systemdAvailable) {
		const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-hjVFZe9e.js").then((n) => n.r);
