...
import { c as normalizeAgentId, n as DEFAULT_AGENT_ID, t as DEFAULT_ACCOUNT_ID } from "./session-key-CZkcvAtx.js";
...
import { c as resolveDefaultAgentId, f as DEFAULT_AGENT_WORKSPACE_DIR, h as DEFAULT_IDENTITY_FILENAME, r as resolveAgentDir, s as resolveAgentWorkspaceDir, t as listAgentIds, w as resolveDefaultAgentWorkspaceDir, x as ensureAgentWorkspace } from "./agent-scope-C9VjJXEK.js";
import { c as writeConfigFile, i as loadConfig, o as readConfigFileSnapshot, r as createConfigIO } from "./config-BUOaEEN4.js";
import { t as parseDurationMs } from "./parse-duration-YRmewVi8.js";
import { n as movePathToTrash } from "./server-context-fHEcd_eR.js";
import { i as randomIdempotencyKey, n as callGateway } from "./call-D0Q9xKag.js";
...
import { D as runMemoryStatus, E as registerMemoryCli, Hn as CHANNEL_TARGETS_DESCRIPTION, Sn as formatTargetDisplay, Un as CHANNEL_TARGET_DESCRIPTION, _ as randomToken, a as applyWizardMetadata, c as ensureWorkspaceAndSessions, d as handleReset, dn as lookupContextTokens, f as moveToTrash, i as DEFAULT_WORKSPACE, l as formatControlUiSshHint, m as openUrl, mn as runMessageAction, s as detectBrowserOpenSupport, un as resolveCommitHash, v as resolveControlUiLinks, wn as CHANNEL_MESSAGE_ACTION_NAMES, x as waitForGatewayReachable } from "./loader-C10Z-_b5.js";
import { n as withProgress } from "./progress-CmhSgg6x.js";
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-DkSrWvZw.js";
import { t as WizardCancelledError } from "./prompts-Dszjy1n_.js";
import { t as createClackPrompter } from "./clack-prompter-DeQcZRms.js";
import { t as resolveChannelDefaultAccountId } from "./helpers-DMuIsfqB.js";
import { n as setupChannels } from "./onboard-channels-BEiXV9yk.js";
import { a as resolveSessionTranscriptsDirForAgent, i as resolveSessionTranscriptsDir, o as resolveStorePath } from "./paths-KDZeTcQQ.js";
import { d as loadSessionStore } from "./sandbox-Cww7Jyn-.js";
import { r as runCommandWithRuntime } from "./cli-utils-B7iQwCY5.js";
import { n as ensurePluginRegistryLoaded, t as hasExplicitOptions } from "./command-options-B-UzAffs.js";
import { l as getVerboseFlag, o as getFlagValue, r as registerSubCliCommands, s as getPositiveIntFlagValue, u as hasFlag } from "./register.subclis-eGfkvaDt.js";
import { n as parsePositiveIntOrUndefined, t as collectOption } from "./helpers-CRGd0w3b.js";
import { n as callGatewayFromCli, t as addGatewayClientOptions } from "./gateway-rpc-D8UeTavw.js";
import { t as createDefaultDeps } from "./deps-H2tCBABX.js";
import { a as gatewayInstallErrorHint, h as assertSupportedRuntime, i as buildGatewayInstallPlan, r as isGatewayDaemonRuntime, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-QsiCCdW4.js";
import { t as resolveGatewayService } from "./service-D0-Epg6G.js";
import { r as isSystemdUserServiceAvailable } from "./systemd-Bn7qQV3U.js";
import { t as renderTable } from "./table-dQAz_LIH.js";
import { d as applyAuthChoice, f as applyOpenAIConfig, h as promptAuthChoiceGrouped, m as applyGoogleGeminiModelDefault, p as upsertSharedEnvVar, u as warnIfModelConfigLooksOff } from "./onboard-skills-DkBKPwqh.js";
import { l as healthCommand } from "./health-format-B4hXu53s.js";
import { $ as setVeniceApiKey, C as applyMoonshotConfig, D as applyOpenrouterConfig, F as applyXaiConfig, G as setCloudflareAiGatewayConfig, J as setMinimaxApiKey, K as setGeminiApiKey, L as applyXiaomiConfig, N as applyVercelAiGatewayConfig, Q as setSyntheticApiKey, W as setAnthropicApiKey, X as setOpencodeZenApiKey, Y as setMoonshotApiKey, Z as setOpenrouterApiKey, ct as buildTokenProfileId, et as setVercelAiGatewayApiKey, f as applyOpencodeZenConfig, g as applyMinimaxConfig, j as applyVeniceConfig, k as applySyntheticConfig, lt as validateAnthropicSetupToken, m as applyMinimaxApiConfig, nt as setXiaomiApiKey, q as setKimiCodingApiKey, rt as setZaiApiKey, tt as setXaiApiKey, v as applyAuthProfileConfig, w as applyMoonshotConfigCn, x as applyKimiCodeConfig, y as applyCloudflareAiGatewayConfig, z as applyZaiConfig } from "./github-copilot-auth-Nh8Vm2uy.js";
import { n as logConfigUpdated, t as formatConfigPath } from "./logging-DcQ6jftd.js";
import { a as findAgentEntryIndex, c as pruneAgentConfig, d as parseIdentityMarkdown, f as runOnboardingWizard, i as buildAgentSummaries, l as identityHasValues, o as listAgentEntries, r as applyAgentConfig, s as loadAgentIdentity, t as statusCommand } from "./status-CaUsVnYq.js";
import { a as createOutboundSendDeps, n as resolveSessionKeyForRequest, t as agentCommand } from "./agent-CRChmow3.js";
import { t as formatHelpExamples } from "./help-format-BBZy5-Be.js";
import { i as CONFIGURE_WIZARD_SECTIONS, n as configureCommand, r as configureCommandWithSections } from "./configure-CLUR3g0g.js";
import { n as ensureSystemdUserLingerNonInteractive } from "./systemd-linger-B9e246TA.js";
import { n as loadAndMaybeMigrateDoctorConfig, t as doctorCommand } from "./doctor-Cx1qNbI1.js";
...
function registerConfigCli(program) {
	const cmd = program.command("config").description("Config helpers (get/set/unset). Run without subcommand for the wizard.").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/config", "docs.openclaw.ai/cli/config")}\n`).option("--section <section>", "Configure wizard sections (repeatable). Use with no subcommand.", (value, previous) => [...previous, value], []).action(async (opts) => {
		const { CONFIGURE_WIZARD_SECTIONS, configureCommand, configureCommandWithSections } = await import("./configure-CLUR3g0g.js").then((n) => n.t);
