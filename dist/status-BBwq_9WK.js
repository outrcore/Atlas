...
import { N as resolveConfiguredModelRef, _ as ensureAuthProfileStore, _t as DEFAULT_PROVIDER, gt as DEFAULT_MODEL, ht as DEFAULT_CONTEXT_TOKENS } from "./auth-profiles-CYBuGiBb.js";
import { r as resolveCliName, t as formatCliCommand } from "./command-format-ayFsmwwz.js";
import { _ as parseAgentSessionKey, c as normalizeAgentId } from "./session-key-CZkcvAtx.js";
...
import { c as resolveDefaultAgentId, h as DEFAULT_IDENTITY_FILENAME, p as DEFAULT_BOOTSTRAP_FILENAME, r as resolveAgentDir, s as resolveAgentWorkspaceDir } from "./agent-scope-C9VjJXEK.js";
import { A as VERSION, c as writeConfigFile, i as loadConfig, o as readConfigFileSnapshot } from "./config-BoIfSsEL.js";
import { f as inspectPortUsage, m as formatPortDiagnostics } from "./errors-aEe1_KOk.js";
import { a as findTailscaleBinary, o as getTailnetHostname, s as readTailscaleStatusJson } from "./tailscale-iX1Q6arn.js";
import { n as callGateway, t as buildGatewayConnectionDetails } from "./call-ArM5G_0c.js";
import { n as listChannelPlugins } from "./plugins-DqNdnGMR.js";
import { Fn as readRestartSentinel, In as summarizeRestartSentinel, Jt as loadProviderUsageSummary, Kn as peekSystemEvents, Qt as listAgentsForGateway, Yt as formatUsageReportLines, _ as randomToken, a as applyWizardMetadata, b as summarizeExistingConfig, c as ensureWorkspaceAndSessions, d as handleReset, dn as lookupContextTokens, g as probeGatewayReachable, h as printWizardHeader, i as DEFAULT_WORKSPACE, l as formatControlUiSshHint, m as openUrl, p as normalizeGatewayTokenInput, q as getRemoteSkillEligibility, s as detectBrowserOpenSupport, v as resolveControlUiLinks, w as normalizeControlUiBasePath, x as waitForGatewayReachable } from "./loader-CT-eGFpU.js";
...
import { n as getMemorySearchManager } from "./memory-CPZGC-m4.js";
import { o as resolveStorePath } from "./paths-KDZeTcQQ.js";
import { I as resolveMainSessionKey, d as loadSessionStore } from "./sandbox-BRrzsAPQ.js";
import { t as buildChannelSummary } from "./channel-summary-hJu8wgNa.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-DkP9obUc.js";
import { r as installCompletion } from "./completion-cli-C-DA9xaJ.js";
import { a as gatewayInstallErrorHint, i as buildGatewayInstallPlan, n as GATEWAY_DAEMON_RUNTIME_OPTIONS, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-DaQFqgu9.js";
import { o as resolveGatewayLogPaths, t as resolveGatewayService } from "./service-D0-Epg6G.js";
import { r as isSystemdUserServiceAvailable } from "./systemd-Bn7qQV3U.js";
import { o as readLastGatewayErrorLine } from "./service-audit-xn3QhmTj.js";
import { t as renderTable } from "./table-dQAz_LIH.js";
import { i as probeGateway, t as runSecurityAudit } from "./audit-C-ly35r1.js";
import { d as applyAuthChoice, h as promptAuthChoiceGrouped, l as resolvePreferredProviderForAuthChoice, o as applyPrimaryModel, r as promptRemoteGatewayConfig, s as promptDefaultModel, t as setupSkills, u as warnIfModelConfigLooksOff } from "./onboard-skills-BQyzqWTu.js";
import { l as healthCommand, n as ensureControlUiAssetsBuilt, s as formatHealthChannelLines, t as formatHealthCheckFailure, u as resolveHeartbeatSummaryForAgent } from "./health-format-DG4pgRsz.js";
import { C as resolveEffectiveUpdateChannel, S as normalizeUpdateChannel, c as formatUpdateOneLiner, d as checkShellCompletionStatus, h as compareSemverStrings, l as getUpdateCheckResult, m as checkUpdateStatus, p as ensureCompletionCacheExists, s as formatUpdateAvailableHint, u as resolveUpdateAvailability, x as formatUpdateChannelLabel } from "./update-runner-CcY-ssuk.js";
import { n as logConfigUpdated } from "./logging-DcQ6jftd.js";
import { t as buildWorkspaceHookStatus } from "./hooks-status-CwY7TcQv.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-DEVprZKn.js";
import { t as runTui } from "./tui-DB1io0yx.js";
import { t as resolveNodeService } from "./node-service-DIRoejB3.js";
import { i as redactSecrets, n as formatDuration$1, r as formatGatewayAuthUsed, t as formatAge$1 } from "./format-B_d9lAIJ.js";
...
async function finalizeOnboardingWizard(options) {
	...
	if (process.platform === "linux" && systemdAvailable) {
		const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-B9e246TA.js").then((n) => n.r);
