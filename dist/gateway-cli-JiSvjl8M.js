import { B as normalizeElevatedLevel, H as normalizeThinkLevel, I as formatThinkingLevels, K as supportsXHighThinking, L as formatXHighModelHint, U as normalizeUsageDisplay, V as normalizeReasoningLevel, W as normalizeVerboseLevel } from "./pi-embedded-helpers-yp9nTa28.js";
import { $n as setTtsProvider, A as resolveOutboundTarget, An as normalizePollInput, Ar as DEFAULT_INPUT_TIMEOUT_MS, At as buildControlUiAvatarUrl, B as scheduleGatewaySigusr1Restart, Bn as registerInternalHook, Bt as listNodePairing, C as resolveSessionTranscriptCandidates, Cr as DEFAULT_INPUT_FILE_MIMES, D as resolveOutboundSessionRoute, Dn as onAgentEvent, Dr as DEFAULT_INPUT_PDF_MAX_PAGES, E as ensureOutboundSessionEntry, En as getAgentRunContext, Er as DEFAULT_INPUT_MAX_REDIRECTS, F as runWithModelFallback, Fn as formatUserTime, Fr as resolveAgentTimeoutMs, Ft as recordRemoteNodeInfo, Gn as isTtsEnabled, Gt as verifyNodeToken, H as consumeRestartSentinel, Hn as OPENAI_TTS_MODELS, Ht as renamePairedNode, In as resolveUserTimeFormat, It as refreshRemoteBinsForConnectedNodes, J as writeRestartSentinel, Jn as resolveTtsAutoMode, Jt as buildSafeExternalPrompt, K as summarizeRestartSentinel, Kn as isTtsProviderConfigured, Kt as getSkillsSnapshotVersion, L as authorizeGatewaySigusr1Restart, Ln as resolveUserTimezone, Lt as refreshRemoteNodeBins, Mr as extractImageContentFromSource, Mt as resolveAssistantAvatarUrl, N as resetDirectoryCache, Nn as resolveAgentIdentity, Nr as normalizeMimeList, Nt as getRemoteSkillEligibility, On as registerAgentRunContext, Or as DEFAULT_INPUT_PDF_MAX_PIXELS, Pt as primeRemoteSkillsCache, Qn as setTtsEnabled, R as consumeGatewaySigusr1RestartAuthorization, Rn as clearInternalHooks, Rt as setSkillsRemoteRegistry, S as readSessionPreviewItemsFromTranscript, Sn as initSubagentRegistry, Sr as DEFAULT_INPUT_FILE_MAX_CHARS, Tn as emitAgentEvent, Tr as DEFAULT_INPUT_IMAGE_MIMES, U as formatDoctorNonInteractiveHint, Un as OPENAI_TTS_VOICES, Ut as requestNodePairing, V as setGatewaySigusr1RestartPolicy, Vn as triggerInternalHook, Vt as rejectNodePairing, W as formatRestartSentinelMessage, Wn as getTtsProvider, Wt as updatePairedNodeMetadata, X as normalizeCronJobPatch, Xn as resolveTtsPrefsPath, Xt as getHookType, Y as normalizeCronJobCreate, Yn as resolveTtsConfig, Yt as detectSuspiciousPatterns, Z as migrateLegacyCronPayload, Zn as resolveTtsProviderOrder, Zt as isExternalHookSession, _ as resolveGatewaySessionStoreTarget, _n as dispatchInboundMessage, _r as enqueueSystemEvent, a as normalizeSendPolicy, ar as stopDiagnosticHeartbeat, b as capArrayByJsonBytes, bn as isAbortTrigger, br as loadModelCatalog, c as runEmbeddedPiAgent, d as createOpenClawTools, dr as stripHeartbeatToken, er as textToSpeech, et as requestHeartbeatNow, f as resolveAnnounceTargetFromKey, fr as lookupContextTokens, g as loadSessionEntry, gr as parseVerboseOverride, h as loadCombinedSessionStoreForGateway, hr as applyVerboseOverride, i as runCliAgent, in as registerUnhandledRejectionHandler, ir as startDiagnosticHeartbeat, it as loadProviderUsageSummary, j as resolveSessionDeliveryTarget, jr as extractFileContentFromSource, jt as normalizeControlUiBasePath, kr as DEFAULT_INPUT_PDF_MIN_TEXT_CHARS, kt as CONTROL_UI_AVATAR_PREFIX, l as abortEmbeddedPiRun, ln as getLastHeartbeatEvent, lt as handleSlackHttpRequest, m as listSessionsFromStore, mn as getChannelActivity, mr as applyModelOverrideToSessionEntry, n as getCliSessionId, nn as normalizeGroupActivation, nr as setCommandLaneConcurrency, nt as getPluginToolMeta, o as resolveSendPolicy, on as buildHistoryContextFromEntries, or as isDiagnosticsEnabled, p as listAgentsForGateway, qn as resolveTtsApiKey, qt as registerSkillsChangeListener, r as setCliSessionId, rr as CommandLane, rt as loadOpenClawPlugins, s as clearSessionQueues, sn as resolveHeartbeatVisibility, sr as DEFAULT_HEARTBEAT_ACK_MAX_CHARS, tn as createReplyPrefixOptions, u as waitForEmbeddedPiRunEnd, un as onHeartbeatEvent, v as resolveSessionModelRef, vn as createReplyDispatcher, vr as isSystemEventContextChanged, vt as handleReset, w as stripEnvelopeFromMessages, wn as clearAgentRunContext, wr as DEFAULT_INPUT_IMAGE_MAX_BYTES, x as readSessionMessages, xn as stopSubagentsForRequester, xr as DEFAULT_INPUT_FILE_MAX_BYTES, y as archiveFileOnDisk, yn as formatZonedTimestamp, z as isGatewaySigusr1RestartExternallyAllowed, zn as createInternalHookEvent, zt as approveNodePairing } from "./reply-dpzhSRJz.js";
...
import { A as VERSION, O as resolveAgentMaxConcurrent, a as parseConfigJson5, c as writeConfigFile, i as loadConfig, k as resolveSubagentMaxConcurrent, l as validateConfigObjectWithPlugins, n as migrateLegacyConfig, o as readConfigFileSnapshot, r as createConfigIO, s as resolveConfigSnapshotHash, u as OpenClawSchema, w as applyLegacyMigrations } from "./config-BgesjbOU.js";
import { o as isTestDefaultMemorySlotDisabled } from "./manifest-registry-DHaa1SJb.js";
import { n as listChannelPlugins, r as normalizeChannelId, t as getChannelPlugin } from "./plugins-BUOltOVc.js";
...
import { T as formatErrorMessage, d as inspectPortUsage, l as ensurePortAvailable, p as formatPortDiagnostics } from "./chrome-DXeEqzlO.js";
import { d as hasBinary, i as loadWorkspaceSkillEntries, r as buildWorkspaceSkillSnapshot } from "./skills-CJ7mwV4S.js";
import { c as saveMediaBuffer, l as detectMime } from "./routes-BRAgjbC0.js";
import "./server-context-WLgtN8If.js";
import { t as rawDataToString } from "./ws-6_dFpKWQ.js";
import { f as GATEWAY_CLIENT_CAPS, g as hasGatewayClientCap, h as GATEWAY_CLIENT_NAMES, i as isGatewayMessageChannel, l as normalizeMessageChannel, m as GATEWAY_CLIENT_MODES, n as isDeliverableMessageChannel, p as GATEWAY_CLIENT_IDS, r as isGatewayCliClient, s as isWebchatClient, t as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-D8bD438k.js";
import "./logging-kuFzZMsG.js";
import "./accounts-CnZyZGal.js";
import { n as resolveSessionFilePath, o as resolveStorePath, r as resolveSessionTranscriptPath } from "./paths-dxnbLZuf.js";
import "./redact-CVRUv382.js";
import "./tool-display-BUbpcaio.js";
import { o as normalizeReplyPayloadsForDelivery, t as deliverOutboundPayloads } from "./deliver-DvSIaDs_.js";
import { i as getMachineDisplayName, t as createBrowserRouteDispatcher } from "./dispatcher-DR7gv8QL.js";
import "./memory-CZ3Y3KK-.js";
import "./manager-D6u5aECn.js";
import "./sqlite-wME36UET.js";
import "./channel-summary-YVQVIBBH.js";
import { $ as validatePollParams, A as validateDevicePairListParams, At as deriveDeviceIdFromPublicKey, B as validateLogsTailParams, C as validateCronListParams, Ct as PROTOCOL_VERSION, D as validateCronStatusParams, Dt as parseSessionLabel, E as validateCronRunsParams, F as validateExecApprovalResolveParams, G as validateNodeInvokeResultParams, H as validateNodeDescribeParams, I as validateExecApprovalsGetParams, J as validateNodePairListParams, K as validateNodeListParams, L as validateExecApprovalsNodeGetParams, M as validateDeviceTokenRevokeParams, Mt as normalizeDevicePublicKeyBase64Url, N as validateDeviceTokenRotateParams, Nt as verifyDeviceSignature, O as validateCronUpdateParams, Ot as buildDeviceAuthPayload, P as validateExecApprovalRequestParams, Q as validateNodeRenameParams, R as validateExecApprovalsNodeSetParams, S as validateCronAddParams, St as validateWizardStatusParams, T as validateCronRunParams, Tt as errorShape, U as validateNodeEventParams, V as validateModelsListParams, W as validateNodeInvokeParams, X as validateNodePairRequestParams, Y as validateNodePairRejectParams, Z as validateNodePairVerifyParams, _ as validateConfigGetParams, _t as validateWebLoginStartParams, a as validateAgentWaitParams, at as validateSessionsPatchParams, b as validateConfigSetParams, bt as validateWizardNextParams, c as validateAgentsFilesSetParams, ct as validateSessionsResolveParams, d as validateChannelsStatusParams, dt as validateSkillsInstallParams, et as validateRequestFrame, f as validateChatAbortParams, ft as validateSkillsStatusParams, g as validateConfigApplyParams, gt as validateWakeParams, h as validateChatSendParams, ht as validateUpdateRunParams, i as validateAgentParams, it as validateSessionsListParams, j as validateDevicePairRejectParams, k as validateDevicePairApproveParams, l as validateAgentsListParams, lt as validateSessionsUsageParams, m as validateChatInjectParams, mt as validateTalkModeParams, n as formatValidationErrors, nt as validateSessionsCompactParams, o as validateAgentsFilesGetParams, ot as validateSessionsPreviewParams, p as validateChatHistoryParams, pt as validateSkillsUpdateParams, q as validateNodePairApproveParams, r as validateAgentIdentityParams, rt as validateSessionsDeleteParams, s as validateAgentsFilesListParams, st as validateSessionsResetParams, tt as validateSendParams, u as validateChannelsLogoutParams, ut as validateSkillsBinsParams, v as validateConfigPatchParams, vt as validateWebLoginWaitParams, w as validateCronRemoveParams, wt as ErrorCodes, x as validateConnectParams, xt as validateWizardStartParams, y as validateConfigSchemaParams, yt as validateWizardCancelParams, z as validateExecApprovalsSetParams } from "./client-DDfckjfC.js";
import { n as pickPrimaryTailnetIPv6, t as pickPrimaryTailnetIPv4 } from "./tailnet-DpzsRR75.js";
import { n as callGateway, o as loadGatewayTlsRuntime$1 } from "./call-GukGvEdr.js";
import "./login-qr-Df8LoqTu.js";
import "./pairing-store-BY4G6jFd.js";
import { t as formatDocsLink } from "./links-CAUfP-NG.js";
import { r as runCommandWithRuntime } from "./cli-utils-B822hMBX.js";
import { n as withProgress } from "./progress-D-Sn_vVh.js";
import { a as resolveSubagentToolPolicy, i as resolveGroupToolPolicy, r as resolveEffectiveToolPolicy, t as filterToolsByPolicy } from "./pi-tools.policy-CxKU_Y6A.js";
import "./prompt-style-BaZUWMLj.js";
import "./pairing-labels-SHig9vz3.js";
import { i as loadSessionUsageTimeSeries, l as hasNonzeroUsage, n as loadCostUsageSummary, r as loadSessionCostSummary, t as discoverAllSessions } from "./session-cost-usage-CjJbWqU0.js";
import { n as formatTokenCount, r as formatUsd } from "./usage-format-hd37en6b.js";
import { c as normalizeExecApprovals, g as saveExecApprovals, l as readExecApprovalsSnapshot, m as resolveExecApprovalsSocketPath, r as ensureExecApprovals } from "./exec-approvals-DAqSYIm7.js";
import { n as createBrowserControlContext, r as startBrowserControlServiceFromConfig } from "./control-service-DX_bhYiI.js";
import { t as parseAbsoluteTimeMs } from "./parse-DqAvJRIf.js";
import { n as resolveMessageChannelSelection } from "./channel-selection-3MDmbeey.js";
import { n as createOutboundSendDeps, t as createDefaultDeps } from "./deps-Do167wEI.js";
import { i as enableTailscaleServe, n as disableTailscaleServe, o as getTailnetHostname, r as enableTailscaleFunnel, t as disableTailscaleFunnel } from "./tailscale-DL3r7EER.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-BvSQaAvB.js";
import "./daemon-runtime-igZ4hBae.js";
import { c as loadAgentIdentity, d as loadAgentIdentityFromWorkspace, p as forceFreePortAndWait, r as getStatusSummary, t as runOnboardingWizard } from "./onboarding-D4UXRctq.js";
import { t as resolveChannelDefaultAccountId } from "./helpers-DTzk1_7G.js";
import "./logging-bnZnBEMz.js";
import "./note-BQPoD0WU.js";
import { t as WizardCancelledError } from "./prompts--d-6l5Ln.js";
import { i as discoverGatewayBeacons, n as installSkill } from "./onboard-skills-DvHiIIG6.js";
import "./github-copilot-auth-DeUdUHsC.js";
import "./onboard-channels-CwxFU1dC.js";
import { r as buildChannelUiCatalog, t as applyPluginAutoEnable } from "./plugin-auto-enable-lTb5wu15.js";
import "./archive-CXhvR9nU.js";
import "./skill-scanner-BuJ49HsN.js";
import "./installs-wyp0NZ_2.js";
import { a as resolveControlUiRootOverrideSync, c as getHealthSnapshot, d as runHeartbeatOnce, f as setHeartbeatsEnabled, n as ensureControlUiAssetsBuilt, o as resolveControlUiRootSync, p as startHeartbeatRunner, s as formatHealthChannelLines } from "./health-format-CGAqId7r.js";
import { S as normalizeUpdateChannel, _ as resolveNpmChannelTag, h as compareSemverStrings, m as checkUpdateStatus, t as runGatewayUpdate, y as DEFAULT_PACKAGE_CHANNEL } from "./update-runner-B5vMZaNe.js";
import { a as resolveGatewayBindHost, n as isLoopbackHost$2, o as resolveGatewayClientIp, r as isTrustedProxyAddress, s as resolveGatewayListenHosts, t as isLoopbackAddress } from "./net-ByVsqv9L.js";
import { i as resolveGatewayAuth, n as authorizeGatewayConnect, r as isLocalDirectRequest, t as assertGatewayAuthConfigured } from "./auth-CkPDqXiG.js";
import { i as probeGateway } from "./audit-BYMr_PRw.js";
import "./table-BGckvCec.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-BU_CzdFV.js";
import "./service-uHr-jUwR.js";
import "./systemd-CygI0Jrf.js";
import "./service-audit-CrZjNGvk.js";
import "./node-service-DM1af1kY.js";
import "./channels-status-issues-BdrlvuAq.js";
import "./completion-cli-4EM3qNKp.js";
import { a as createOutboundSendDeps$1, i as resolveAgentOutboundTarget, r as resolveAgentDeliveryPlan, t as agentCommand } from "./agent-upodtkzu.js";
import { n as resolveWideAreaDiscoveryDomain, r as writeWideAreaGatewayZone } from "./widearea-dns-CDV3muNv.js";
import { i as shouldIncludeHook, n as loadWorkspaceHookEntries, r as resolveHookConfig } from "./hooks-status-CLfJAHQD.js";
import "./tui-Cww_zQNJ.js";
import { t as buildChannelAccountSnapshot } from "./status-DDWSxpVo.js";
import "./shared-CvCZ08EB.js";
import { a as runDaemonStop, i as runDaemonStart, n as runDaemonStatus, o as runDaemonUninstall, r as runDaemonRestart, s as runDaemonInstall } from "./daemon-cli-DgzQdRHr.js";
import { a as toOptionString, i as parsePort$1, n as extractGatewayMiskeys, r as maybeExplainGatewayServiceStop, t as describeUnknownError } from "./shared-BpQZfUSl.js";
import { i as setGatewayWsLogStyle, n as logWs, r as summarizeAgentEventForWsLog, t as formatForLog } from "./ws-log-Ba3Htmyn.js";
import { T as resolveGmailHookRuntimeConfig, _ as buildGogWatchServeArgs, i as ensureTailscaleEndpoint, v as buildGogWatchStartArgs } from "./gmail-setup-utils-Co9eLhfV.js";
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-CWVQjmiy.js");
...
const usageHandlers = {
	...
	"sessions.usage.logs": async ({ respond, params }) => {
		...
		const { loadSessionLogs } = await import("./session-cost-usage-CjJbWqU0.js").then((n) => n.a);
...
async function startBrowserControlServerIfEnabled() {
	...
	const mod = override ? await import(override) : await import("./control-service-DX_bhYiI.js").then((n) => n.t);
