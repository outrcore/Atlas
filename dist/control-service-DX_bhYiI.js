...
import { S as ensureChromeExtensionRelayServer } from "./chrome-DXeEqzlO.js";
import { a as resolveProfile, i as resolveBrowserConfig, t as createBrowserRouteContext } from "./server-context-WLgtN8If.js";
...
async function stopBrowserControlService() {
	...
	state = null;
	try {
		await (await import("./pw-ai-D06ffpws.js")).closePlaywrightBrowserConnection();
	} catch {}
}
