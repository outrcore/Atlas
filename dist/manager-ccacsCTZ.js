...
import { nt as resolveApiKeyForProvider, tt as requireApiKey } from "./auth-profiles-CYBuGiBb.js";
import { _ as sleep, b as truncateUtf16Safe, m as resolveUserPath, n as clampInt, r as clampNumber$1 } from "./utils-DX85MiPR.js";
import { n as resolveAgentConfig, r as resolveAgentDir, s as resolveAgentWorkspaceDir } from "./agent-scope-C9VjJXEK.js";
import { a as resolveSessionTranscriptsDirForAgent } from "./paths-KDZeTcQQ.js";
import { n as onSessionTranscriptUpdate } from "./transcript-events-Ch7wLX-j.js";
import { a as ensureDir, c as listMemoryFiles, i as cosineSimilarity, l as normalizeExtraMemoryPaths, n as buildFileEntry, o as hashText, r as chunkMarkdown, s as isMemoryPath, t as requireNodeSqlite, u as parseEmbedding } from "./sqlite-Bea7mwdA.js";
...
var MemoryIndexManager = class MemoryIndexManager {
	...
	computeProviderKey() {
		if (this.provider.id === "openai" && this.openAi) {
			if (/^https?:\/\/(127\.0\.0\.1|localhost)(:\d+)?/i.test(this.openAi.baseUrl)) {
				return hashText(JSON.stringify({ provider: "local", model: this.provider.model }));
			}
