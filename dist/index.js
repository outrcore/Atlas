...
import { $ as CHANNEL_TARGET_DESCRIPTION, $t as runMemoryStatus, M as formatTargetDisplay, Ot as waitForGatewayReachable, P as CHANNEL_MESSAGE_ACTION_NAMES, Pr as applyTemplate, Q as CHANNEL_TARGETS_DESCRIPTION, Qt as registerMemoryCli, T as runMessageAction, Tt as resolveControlUiLinks, an as waitForever, ct as resolveCommitHash, dt as DEFAULT_WORKSPACE, en as monitorWebChannel, fr as lookupContextTokens, ft as applyWizardMetadata, gt as formatControlUiSshHint, ht as ensureWorkspaceAndSessions, mt as detectBrowserOpenSupport, rn as installUnhandledRejectionHandler, t as getReplyFromConfig, vt as handleReset, wt as randomToken, xt as openUrl, yt as moveToTrash } from "./reply-dpzhSRJz.js";
...
import { c as normalizeAgentId, n as DEFAULT_AGENT_ID, t as DEFAULT_ACCOUNT_ID } from "./session-key-Dm2EOhrH.js";
...
import { c as resolveDefaultAgentId, f as DEFAULT_AGENT_WORKSPACE_DIR, h as DEFAULT_IDENTITY_FILENAME, r as resolveAgentDir, s as resolveAgentWorkspaceDir, t as listAgentIds, w as resolveDefaultAgentWorkspaceDir, x as ensureAgentWorkspace } from "./agent-scope-CMs5Y7l-.js";
...
import { A as VERSION, c as writeConfigFile, i as loadConfig, o as readConfigFileSnapshot, r as createConfigIO } from "./config-BgesjbOU.js";
import "./manifest-registry-DHaa1SJb.js";
import { t as parseDurationMs } from "./parse-duration-BTtC56U7.js";
import { n as listChannelPlugins, r as normalizeChannelId, t as getChannelPlugin } from "./plugins-BUOltOVc.js";
import { D as resolveSessionKey, E as deriveSessionKey, d as loadSessionStore, m as saveSessionStore } from "./sandbox-DRFM-VuR.js";
import "./image-CeOzom1Z.js";
import "./pi-model-discovery-EwKVHlZB.js";
import { E as formatUncaughtError, c as describePortOwner, l as ensurePortAvailable, s as PortInUseError, u as handlePortError } from "./chrome-DXeEqzlO.js";
import "./skills-CJ7mwV4S.js";
import "./routes-BRAgjbC0.js";
import { n as movePathToTrash } from "./server-context-WLgtN8If.js";
import { h as GATEWAY_CLIENT_NAMES, l as normalizeMessageChannel, m as GATEWAY_CLIENT_MODES } from "./message-channel-D8bD438k.js";
import "./logging-kuFzZMsG.js";
import "./accounts-CnZyZGal.js";
import { a as resolveSessionTranscriptsDirForAgent, i as resolveSessionTranscriptsDir, o as resolveStorePath } from "./paths-dxnbLZuf.js";
...
import { i as randomIdempotencyKey, n as callGateway } from "./call-GukGvEdr.js";
...
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-BaZUWMLj.js";
...
import { t as createDefaultDeps } from "./deps-Do167wEI.js";
import { l as ensureBinary, u as promptYesNo } from "./tailscale-DL3r7EER.js";
import { t as isMainModule } from "./is-main-DQvkVwTK.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-BvSQaAvB.js";
import { a as gatewayInstallErrorHint, g as assertSupportedRuntime, i as buildGatewayInstallPlan, r as isGatewayDaemonRuntime, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-igZ4hBae.js";
import { a as buildAgentSummaries, c as loadAgentIdentity, f as parseIdentityMarkdown, i as applyAgentConfig, l as pruneAgentConfig, n as statusCommand, o as findAgentEntryIndex, s as listAgentEntries, t as runOnboardingWizard, u as identityHasValues } from "./onboarding-D4UXRctq.js";
import { t as resolveChannelDefaultAccountId } from "./helpers-DTzk1_7G.js";
import { n as logConfigUpdated, t as formatConfigPath } from "./logging-bnZnBEMz.js";
import "./note-BQPoD0WU.js";
import { t as WizardCancelledError } from "./prompts--d-6l5Ln.js";
import { t as createClackPrompter } from "./clack-prompter-CayHLO_9.js";
import { d as warnIfModelConfigLooksOff, f as applyAuthChoice, g as promptAuthChoiceGrouped, h as applyGoogleGeminiModelDefault, m as upsertSharedEnvVar, p as applyOpenAIConfig } from "./onboard-skills-DvHiIIG6.js";
import { $ as setVeniceApiKey, C as applyMoonshotConfig, D as applyOpenrouterConfig, F as applyXaiConfig, G as setCloudflareAiGatewayConfig, J as setMinimaxApiKey, K as setGeminiApiKey, L as applyXiaomiConfig, N as applyVercelAiGatewayConfig, Q as setSyntheticApiKey, W as setAnthropicApiKey, X as setOpencodeZenApiKey, Y as setMoonshotApiKey, Z as setOpenrouterApiKey, ct as buildTokenProfileId, et as setVercelAiGatewayApiKey, f as applyOpencodeZenConfig, g as applyMinimaxConfig, j as applyVeniceConfig, k as applySyntheticConfig, lt as validateAnthropicSetupToken, m as applyMinimaxApiConfig, nt as setXiaomiApiKey, q as setKimiCodingApiKey, rt as setZaiApiKey, tt as setXaiApiKey, v as applyAuthProfileConfig, w as applyMoonshotConfigCn, x as applyKimiCodeConfig, y as applyCloudflareAiGatewayConfig, z as applyZaiConfig } from "./github-copilot-auth-DeUdUHsC.js";
import { n as setupChannels } from "./onboard-channels-CwxFU1dC.js";
import "./plugin-auto-enable-lTb5wu15.js";
import "./archive-CXhvR9nU.js";
import "./skill-scanner-BuJ49HsN.js";
import "./installs-wyp0NZ_2.js";
import { l as healthCommand } from "./health-format-CGAqId7r.js";
import "./update-runner-B5vMZaNe.js";
import "./auth-CkPDqXiG.js";
import "./audit-BYMr_PRw.js";
import { t as renderTable } from "./table-BGckvCec.js";
import "./skills-status-BU_CzdFV.js";
import { t as resolveGatewayService } from "./service-uHr-jUwR.js";
import { r as isSystemdUserServiceAvailable } from "./systemd-CygI0Jrf.js";
import "./service-audit-CrZjNGvk.js";
import "./node-service-DM1af1kY.js";
import "./channels-status-issues-BdrlvuAq.js";
import { c as registerSubCliCommands, d as getPositiveIntFlagValue, f as getVerboseFlag, l as getCommandPath, m as hasHelpOrVersion, p as hasFlag, u as getFlagValue } from "./completion-cli-4EM3qNKp.js";
import { n as callGatewayFromCli, t as addGatewayClientOptions } from "./gateway-rpc-4lk4rbnv.js";
import { t as formatHelpExamples } from "./help-format-DU1Dq2gd.js";
import { a as createOutboundSendDeps, n as resolveSessionKeyForRequest, t as agentCommand } from "./agent-upodtkzu.js";
import { i as hasExplicitOptions, n as resolveCliChannelOptions, r as ensurePluginRegistryLoaded } from "./channel-options-BNxmN-Ad.js";
import { n as parsePositiveIntOrUndefined, t as collectOption } from "./helpers-CdNw2RUq.js";
import { i as CONFIGURE_WIZARD_SECTIONS, n as configureCommand, r as configureCommandWithSections } from "./configure-DSPvqJ7N.js";
import { n as ensureSystemdUserLingerNonInteractive } from "./systemd-linger-hjVFZe9e.js";
import "./widearea-dns-CDV3muNv.js";
import "./auth-health-Cm99jnWu.js";
import { n as loadAndMaybeMigrateDoctorConfig, t as doctorCommand } from "./doctor-B2Cmb5Fu.js";
import "./hooks-status-CLfJAHQD.js";
...
function registerConfigCli(program) {
	const cmd = program.command("config").description("Config helpers (get/set/unset). Run without subcommand for the wizard.").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/config", "docs.openclaw.ai/cli/config")}\n`).option("--section <section>", "Configure wizard sections (repeatable). Use with no subcommand.", (value, previous) => [...previous, value], []).action(async (opts) => {
		const { CONFIGURE_WIZARD_SECTIONS, configureCommand, configureCommandWithSections } = await import("./configure-DSPvqJ7N.js").then((n) => n.t);
