...
import { c as writeConfigFile, i as loadConfig, o as readConfigFileSnapshot, r as createConfigIO } from "./config-BoIfSsEL.js";
import { t as parseDurationMs } from "./parse-duration-YRmewVi8.js";
import { n as movePathToTrash } from "./server-context-fHEcd_eR.js";
import { i as randomIdempotencyKey, n as callGateway } from "./call-ArM5G_0c.js";
...
import { n as setupChannels } from "./onboard-channels-Dy2I5cYI.js";
...
import { d as loadSessionStore } from "./sandbox-BRrzsAPQ.js";
import { r as runCommandWithRuntime } from "./cli-utils-B7iQwCY5.js";
import { n as ensurePluginRegistryLoaded, t as hasExplicitOptions } from "./command-options-DLCj_6g_.js";
import { l as getVerboseFlag, o as getFlagValue, r as registerSubCliCommands, s as getPositiveIntFlagValue, u as hasFlag } from "./register.subclis-eIpP9Ku-.js";
import { n as parsePositiveIntOrUndefined, t as collectOption } from "./helpers-CRGd0w3b.js";
import { n as callGatewayFromCli, t as addGatewayClientOptions } from "./gateway-rpc-B81pMevL.js";
import { t as createDefaultDeps } from "./deps-DM9mW0bN.js";
import { a as gatewayInstallErrorHint, h as assertSupportedRuntime, i as buildGatewayInstallPlan, r as isGatewayDaemonRuntime, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-DaQFqgu9.js";
...
function registerConfigCli(program) {
	const cmd = program.command("config").description("Config helpers (get/set/unset). Run without subcommand for the wizard.").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/config", "docs.openclaw.ai/cli/config")}\n`).option("--section <section>", "Configure wizard sections (repeatable). Use with no subcommand.", (value, previous) => [...previous, value], []).action(async (opts) => {
		const { CONFIGURE_WIZARD_SECTIONS, configureCommand, configureCommandWithSections } = await import("./configure-lirpnRZS.js").then((n) => n.t);
