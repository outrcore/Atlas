...
import { a as resolveBrowserConfig, o as resolveProfile, t as createBrowserRouteContext } from "./server-context-fHEcd_eR.js";
import { S as ensureChromeExtensionRelayServer } from "./errors-aEe1_KOk.js";
...
async function stopBrowserControlService() {
	...
	state = null;
	try {
		await (await import("./pw-ai-wkSjmbaI.js")).closePlaywrightBrowserConnection();
	} catch {}
}
